...
edge_index2 = deepcopy(final_edge_index)

final_edge_index = model.get_all_trojan_edge()
final_x = final_x.to('cpu')
final_edge_index = final_edge_index.to('cpu')
...
print(final_list)
ori_edge_index =  deepcopy(data.edge_index)
ori_x = deepcopy(data.x)
print(ori_edge_index.shape)