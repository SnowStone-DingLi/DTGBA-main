...
Our hyperparameter's settings have been given in `parser.add_argument` of the code.
...
#### SBA-Gen
This is a variant of SBA-Samp, which uses generated features for trigger nodes. [[paper](https://arxiv.org/abs/2006.11165), [code](https://github.com/zaixizhang/graphbackdoor)].
